...
export default function TextInputForm({ value, onChange }: TextInputFormProps) {
    return (
        <form className="w-full mb-4 rounded-lg bg-white/10 backdrop-blur-sm border border-white/10">
            <div className="flex items-center justify-between px-3 py-2 border-b border-white/10">
                <div className="flex flex-wrap items-center sm:divide-x sm:rtl:divide-x-reverse divide-gray-600">
                    <div className="flex items-center space-x-1 rtl:space-x-reverse sm:pe-4">
                        <button type="button" className="p-2 text-gray-400 rounded-sm cursor-pointer hover:text-white hover:bg-gray-600 transition duration-300">
                ...
                <button type="button" className="p-2 text-gray-400 rounded-sm cursor-pointer sm:ms-auto hover:text-white hover:bg-gray-600 transition duration-300">
            ...
            <div className="px-4 py-2 bg-transparent rounded-b-lg">
                <textarea rows={8}
                    className="block w-full px-0 text-sm text-gray-400 border-0 bg-transparent outline-0"
